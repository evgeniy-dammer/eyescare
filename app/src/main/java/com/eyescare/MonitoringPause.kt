...
class MonitoringPause {
    ...
    /**
     * Полный сброс — новая сессия мониторинга: снимает все причины и снуз. Камеру не трогает,
     * решение о ней принимает вызывающий (обычно сразу спрашивая расписание).
     */
    fun reset() {
        reasons.clear()
        snoozeUntilMs = null
